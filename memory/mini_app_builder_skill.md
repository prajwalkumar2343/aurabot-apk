...
- Secondary screens should expose lists, direct buttons, settings, guidance, categories, or workflows.
...
- screens use at least dashboard_block, quick_action_grid, chart or timeline, and one richer component such as list, settings, button, slider, or bottom_sheet.
