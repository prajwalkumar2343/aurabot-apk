                        ...
                        "properties": {
                            ...
                            "actions": {
                                ...
                                "items": {
                                    "type": "object",
                                    "properties": {
                                            "type": {"type": "string", "enum": ["notify", "draft_message", "eta_message", "direct_sms", "open_app", "tap_text", "tap_bounds", "type_text", "wait_for_text", "tap_target", "long_press_target", "clear_text", "scroll", "swipe", "inspect_screen", "press_back", "press_home"]},
                                        "title": {"type": "string"},
                                        ...
                                        "metadata": {
                                            "type": "object",
                                            "description": "String metadata for executors. ETA actions can use destinationLatitude, destinationLongitude, travelMode, averageSpeedKph, and needsEta=true. Cross-app actions use packageName/appQuery, text, targetText, contentDescription, viewId, className, occurrence, partialMatch, timeoutMillis, settleMillis, maxNodes, riskLevel, direction, or gesture bounds/points.",
                                            ...
                                            "properties": {
                                                ...
                                                "action": {
                                                    ...
                                                    "properties": {
                                                        ...
                                                        "metadata": {
                                                            "type": "object",
                                                            "description": "String metadata. Cross-app actions use packageName/appQuery, text, targetText, contentDescription, viewId, className, occurrence, partialMatch, timeoutMillis, settleMillis, maxNodes, riskLevel, direction, or gesture bounds/points.",
                                                            "additionalProperties": {"type": "string"},
                                                        },
                                                    },
                                                    "required": ["type", "requireConfirmation"],
