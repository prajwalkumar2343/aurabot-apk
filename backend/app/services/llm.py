                        ...
                        "properties": {
                            ...
                            "actions": {
                                ...
                                "items": {
                                    "type": "object",
                                    "properties": {
                                            "type": {"type": "string", "enum": ["notify", "draft_message", "eta_message", "direct_sms", "open_app", "wait_for_app", "tap_text", "tap_bounds", "type_text", "wait_for_text", "tap_target", "long_press_target", "clear_text", "scroll", "scroll_until_target", "swipe", "inspect_screen", "press_back", "press_home"]},
                                        "title": {"type": "string"},
