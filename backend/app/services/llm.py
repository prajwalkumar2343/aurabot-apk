...
def build_system_message(data: ChatIn, harness: Optional[PromptHarness] = None) -> str:
    ...
    return (
        ...
        "For cross-app automations, use open_app, wait_for_text, tap_target, tap_text, tap_bounds, type_text, clear_text, scroll, swipe, press_back, and press_home steps. Prefer open_app with packageName from the installed apps list, then wait_for_text before tap/type steps. Prefer stable selectors in metadata, in this order: viewId, contentDescription, exact text, className plus occurrence. Add timeoutMillis for slow screens and settleMillis after app transitions. Cross-app UI control requires the user to enable Aura's Accessibility Service, so avoid direct sends, purchases, deletes, posts, payments, or irreversible actions unless the user explicitly asks and the flow includes a checkpoint. "
                        ...
                        "properties": {
                            ...
                            "actions": {
                                ...
                                "items": {
                                    "type": "object",
                                    "properties": {
                                            "type": {"type": "string", "enum": ["notify", "draft_message", "eta_message", "direct_sms", "open_app", "tap_text", "tap_bounds", "type_text", "wait_for_text", "tap_target", "long_press_target", "clear_text", "scroll", "swipe", "press_back", "press_home"]},
                                        "title": {"type": "string"},
                                        ...
                                        "metadata": {
                                            "type": "object",
                                            "description": "String metadata for executors. ETA actions can use destinationLatitude, destinationLongitude, travelMode, averageSpeedKph, and needsEta=true. Cross-app actions use packageName/appQuery, text, targetText, contentDescription, viewId, className, occurrence, partialMatch, timeoutMillis, settleMillis, direction, or gesture bounds/points.",
                                            ...
                                            "properties": {
                                                ...
                                                "action": {
                                                    ...
                                                    "properties": {
                                                        ...
                                                        "metadata": {
                                                            "type": "object",
                                                            "description": "String metadata. Cross-app actions use packageName/appQuery, text, targetText, contentDescription, viewId, className, occurrence, partialMatch, timeoutMillis, settleMillis, direction, or gesture bounds/points.",
                                                            "additionalProperties": {"type": "string"},
                                                        },
                                                    },
                                                    "required": ["type", "requireConfirmation"],
